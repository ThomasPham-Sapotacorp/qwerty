const ItemModel 	= require(__path_schemas + 'categories');
...
module.exports = {
    ...
    getItemsbyIdGroup: async(id) => {
        return ItemModel
            .find({status:'active', group: id}) 
            .sort({'created.time': 'asc'}) 
            .populate('group')
            .populate({
                path: 'group',
